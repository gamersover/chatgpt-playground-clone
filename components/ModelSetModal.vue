...
<div class="flex flex-col rounded-2xl dark:text-gray-100">
    <div class="h-16 flex justify-between items-center border-b border-black/10 dark:border-white/10 px-4">
        ...
        <div class="flex flex-col flex-1 justify-around items-center gap-6 p-4">
            <div class="flex flex-col gap-2 w-full">
                ...
                <UInput
                    ...
                    :ui="{
                        'base': 'w-full h-[48px]',
                        'variant': {'outline': 'ring-gray-300 hover:ring-gray-400 dark:ring-gray-600 dark:hover:ring-gray-500'},
                    }"
                    color="blue"
                    size="xl"
                >
            ...
            <div class="flex items-center gap-2 self-end">
                <UButton
                    ...
                    :ui="{variant: {solid: 'bg-[#10a37f] hover:bg-[#1a7f64] dark:bg-[#1a7f64] dark:hover:bg-[#1a7f64]/80'}}"
                    class='px-3 py-1.5 dark:text-gray-200 disabled:bg-primary-600/50 dark:disabled:bg-[#1a7f64]/30'
                >
                </UButton>
                <UButton
                   ...
                   color="blue"
                   :ui="{variant: {solid: 'dark:bg-blue-800 dark:hover:bg-blue-800/80 disabled:bg-blue-600/50 dark:disabled:bg-blue-700/30'}}"
