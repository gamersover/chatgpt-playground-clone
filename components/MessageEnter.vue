<template>
  <div
    class="mb-4 px-4 py-4 flex flex-col min-h-[44px] max-h-[400px] w-[800px] ring-1 ring-gray-300 transition-all hover:ring-2 hover:ring-blue-600 dark:hover:ring-blue-400 dark:ring-gray-500 rounded-md"
  >
    <UTextarea
      ref="textarea"
      autoresize
